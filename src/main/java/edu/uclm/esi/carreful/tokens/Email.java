...
public class Email {
	...
	public void send(String destinatario, String subject, String body) {
		...
		String port="465";
		String sender="sanchezperezesquinas@gmail.com";		// REMITENTE
		String serverUser="sanchezperezesquinas@gmail.com";	// USUARIO
		String userAutentication= "true";
		String pwd="disenosft21";				// PONER LA CONTRASEÑA
